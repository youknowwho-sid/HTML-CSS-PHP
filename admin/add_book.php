    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd">
		<div class="container-fluid">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="admin_editprofile.php">Manage Categories</a></li>
            </ul>
          </li>
		      <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="admin_editprofile.php">Manage Authors</a></li>
            </ul>
          </li>
	          <li class="nav-item">
...
<?php
	if(isset($_POST['add_book']))
	{
		...
		$query = "insert into books values (null,'$_POST[book_name]','$_POST[book_author]','$_POST[book_category]',$_POST[book_price], $_POST[isbn])";
		$query_run = mysqli_query($connection,$query);
		echo "<script>alert('New book has been added.')</script>";
	}
?>